 ...
 * @author Bartosz
 */
public class EditWitnessController extends AddWitnessController {

    public EditWitnessController() {
        try {
            ...
            Logger.getLogger(EditWitnessController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        setTitleLabel("Edytuj Świadka");
    }
